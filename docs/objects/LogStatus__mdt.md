...
```mermaid
graph TD
LogStatus__mdt["Log Status"]:::mainObject
click LogStatus__mdt "/objects/LogStatus__mdt/"
...
| :-------- | :---- | :--: | :---------- | 
| IsActive__c | Is Active | Checkbox | undefined |
...
| :-------- | :---- | :---------- | :------ |
| Only_closed_can_be_resolved | Yes |  | AND(<br/>    IsClosed__c = false,<br/>    IsResolved__c = true<br/>) |
