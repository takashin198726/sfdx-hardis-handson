...
| LogEntry__c | Log Entry | MasterDetail | undefined |
| LogEntryOrigin__c | Log Entry Origin | Text | undefined |
| LogEntryTimestamp__c | Log Entry Timestamp | DateTime | undefined |
| LoggedByUsernameLink__c | Username | Text | undefined |
| LogLink__c | Log | Text | undefined |
| ParentLogLink__c | Parent Log | Text | undefined |
| ProfileLink__c | Profile | Text | undefined |
| Tag__c | Logger Tag | MasterDetail | undefined |
| UniqueId__c | Unique ID | Text | An external ID field used to ensure that Log Entry Tag records are unique |
...
| [LogEntryTag](../apex/LogEntryTag.md) | Class |
