...
```mermaid
graph TD
LogEntryTagRule__mdt["Log Entry Tag Rule"]:::mainObject
click LogEntryTagRule__mdt "/objects/LogEntryTagRule__mdt/"
...
| :-------- | :---- | :--: | :---------- | 
| ComparisonType__c | Comparison Type | Picklist | undefined |
| ComparisonValue__c | Comparison Value | LongTextArea | undefined |
| IsEnabled__c | Is Enabled | Checkbox | undefined |
| SObjectField__c | Field | MetadataRelationship | undefined |
| SObjectType__c | Logger SObject | MetadataRelationship | undefined |
| Tags__c | Tag(s) to Apply | LongTextArea | 1 or more tags to assign - each tag should be listed on a separate line |
