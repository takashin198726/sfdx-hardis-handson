...
```mermaid
graph TD
LoggerScenario__c["Logger Scenario"]:::mainObject
...
linkStyle 0,1,3 stroke:#A6A6A6,stroke-width:2px;
...
| :-------- | :---- | :--: | :---------- | 
| UniqueId__c | Unique ID | Text | undefined |
...
| [LoggerScenarioHandler](../apex/LoggerScenarioHandler.md) | Class |
| [LoggerScenarioHandler_Tests](../apex/LoggerScenarioHandler_Tests.md) | Test |
| [LoggerTestConfigurator](../apex/LoggerTestConfigurator.md) | Test |
| [LoggerScenario](../apex/LoggerScenario.md) | Class |
