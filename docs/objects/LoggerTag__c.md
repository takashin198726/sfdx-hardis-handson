...
```mermaid
graph TD
LoggerTag__c["Logger Tag"]:::mainObject
...
| :-------- | :---- | :--: | :---------- | 
| TotalLogEntries__c | Total Log Entries | Summary | undefined |
| UniqueId__c | Unique ID | Text | An external ID field used to ensure that Logger Tag records are unique |
...
| [LoggerTagHandler_Tests](../apex/LoggerTagHandler_Tests.md) | Test |
| [LoggerTestConfigurator](../apex/LoggerTestConfigurator.md) | Test |
| [LoggerTag](../apex/LoggerTag.md) | Class |
