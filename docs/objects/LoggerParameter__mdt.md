...
```mermaid
graph TD
LoggerParameter__mdt["Logger Parameter"]:::mainObject
click LoggerParameter__mdt "/objects/LoggerParameter__mdt/"
...
| Value__c | Value | LongTextArea | undefined |
...
| [LoggerCache](../apex/LoggerCache.md) | Class |
