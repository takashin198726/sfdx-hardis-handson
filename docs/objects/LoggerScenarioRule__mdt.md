...
```mermaid
graph TD
LoggerScenarioRule__mdt["Logger Scenario Rule"]:::mainObject
click LoggerScenarioRule__mdt "/objects/LoggerScenarioRule__mdt/"
...
| IsAnonymousModeEnabled__c | Enable Anonymous Mode | Picklist | undefined |
| IsApexSystemDebugLoggingEnabled__c | Enable Apex System.debug() | Picklist | undefined |
| IsDataMaskingEnabled__c | Enable Data Masking | Picklist | undefined |
| IsEnabled__c | Is Enabled | Checkbox | undefined |
| IsJavaScriptConsoleLoggingEnabled__c | Enable JavaScript console.log() | Picklist | undefined |
| IsJavaScriptLightningLoggerEnabled__c | Enable JavaScript lightning-logger | Picklist | undefined |
| IsLogAssignmentEnabled__c | Assign Logs To Logger Scenario Owner | Picklist | undefined |
| IsLoggerEnabled__c | Is Logger Enabled | Picklist | undefined |
| IsLogRetentionOverrideEnabled__c | Enable Log Retention Override | Picklist | undefined |
| IsPlatformEventStorageLocationEnabled__c | Enable Platform Event Storage Override | Picklist | undefined |
| IsRecordFieldStrippingEnabled__c | Strip Inaccessible Record Fields | Picklist | undefined |
| IsSavingEnabled__c | Enable Saving | Picklist | undefined |
| NumberOfDaysToRetainLogs__c | Days to Retain Logs | Number | undefined |
| PlatformEventStorageLocation__c | Platform Event Storage Location | Text | undefined |
| SaveMethod__c | Save Method | Text | undefined |
| Scenario__c | Scenario | Text | undefined |
...
| [LoggerScenarioRule](../apex/LoggerScenarioRule.md) | Class |
| [LoggerScenarioRule_Tests](../apex/LoggerScenarioRule_Tests.md) | Test |
