...
```mermaid
graph TD
LogEntryDataMaskRule__mdt["Log Entry Data Mask Rule"]:::mainObject
click LogEntryDataMaskRule__mdt "/objects/LogEntryDataMaskRule__mdt/"
...
| :-------- | :---- | :--: | :---------- | 
| ApplyToMessage__c | DEPRECATED: Apply to Message | Checkbox | undefined |
| ApplyToRecordJson__c | Apply to Record JSON | Checkbox | undefined |
| IsEnabled__c | Is Enabled | Checkbox | undefined |
| ReplacementRegEx__c | Replacement RegEx | Text | undefined |
| SensitiveDataRegEx__c | Sensitive Data RegEx | Text | undefined |
