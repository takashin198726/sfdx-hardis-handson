...
```mermaid
graph TD
  IncludesConditionClause["IncludesConditionClause"]:::mainApexClass
  click IncludesConditionClause "/objects/IncludesConditionClause/"
  ...
  IncludesConditionClauseTest --> IncludesConditionClause
...
public with sharing class IncludesConditionClause extends AbstractConditionClause {
  ...
  public override IConditionClause overrideField(String field) {
    return new IncludesConditionClause(this.sObjectType, this.fieldMap, field, this.values);
  }
...
## Constructors
### `IncludesConditionClause(sObjectType, fieldMap, field, values)`

Constructor for IncludesConditionClause

#### Signature
```apex
public IncludesConditionClause(Schema.SObjectType sObjectType, Map<String,Schema.SObjectField> fieldMap, String field, List<String> values)
```
...
| field | String | The field name to apply the INCLUDE condition on. |
