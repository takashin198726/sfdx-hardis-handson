...
# LogEntryEventBuilder_Tests Class
...
```mermaid
graph TD
  LogEntryEventBuilder_Tests["LogEntryEventBuilder_Tests"]:::mainApexClass
  click LogEntryEventBuilder_Tests "/objects/LogEntryEventBuilder_Tests/"
  ...
  LogEntryEventBuilder_Tests --> LogEntryEventBuilder
  LogEntryEventBuilder_Tests --> Logger
  LogEntryEventBuilder_Tests --> LoggerConfigurationSelector
  LogEntryEventBuilder_Tests --> LoggerEngineDataSelector
  LogEntryEventBuilder_Tests --> LoggerMockDataCreator
  LogEntryEventBuilder_Tests --> LoggerParameter
  LogEntryEventBuilder_Tests --> LoggerSObjectProxy
  LogEntryEventBuilder_Tests --> LoggerStackTrace
  LogEntryEventBuilder_Tests --> LogMessage
...
private class LogEntryEventBuilder_Tests {
  ...
  static void it_should_short_circuit_when_disabled() {
    ...
    System.Assert.isNull(builder.setApprovalResult((Approval.LockResult) null).getLogEntryEvent());
    System.Assert.isNull(builder.setApprovalResult((Approval.ProcessResult) null).getLogEntryEvent());
    System.Assert.isNull(builder.setApprovalResult((Approval.UnlockResult) null).getLogEntryEvent());
    System.Assert.isNull(builder.setApprovalResult(new List<Approval.LockResult>()).getLogEntryEvent());
    System.Assert.isNull(builder.setApprovalResult(new List<Approval.ProcessResult>()).getLogEntryEvent());
    System.Assert.isNull(builder.setApprovalResult(new List<Approval.UnlockResult>()).getLogEntryEvent());
    System.Assert.isNull(builder.setDatabaseResult((Database.DeleteResult) null).getLogEntryEvent());
    System.Assert.isNull(builder.setDatabaseResult((Database.EmptyRecycleBinResult) null).getLogEntryEvent());
    System.Assert.isNull(builder.setDatabaseResult((Database.LeadConvertResult) null).getLogEntryEvent());
    ...
    System.Assert.isNull(builder.setDatabaseResult(new List<Database.EmptyRecycleBinResult>()).getLogEntryEvent());
    System.Assert.isNull(builder.setDatabaseResult(new List<Database.LeadConvertResult>()).getLogEntryEvent());
  ...
  static void it_should_set_transaction_limits_fields_when_enabled_via_logger_parameter() {
    ...
    System.Assert.areEqual(System.Limits.getFetchCallsOnApexCursor(), logEntryEvent.LimitsApexCursorFetchCallsUsed__c);
    System.Assert.areEqual(System.Limits.getApexCursorRows(), logEntryEvent.LimitsApexCursorRowsUsed__c);
    ...
    System.Assert.areEqual(System.Limits.getLimitFetchCallsOnApexCursor(), logEntryEvent.LimitsApexCursorFetchCallsMax__c);
    System.Assert.areEqual(System.Limits.getLimitApexCursorRows(), logEntryEvent.LimitsApexCursorRowsMax__c);
  ...
  static void it_should_not_set_transaction_limits_fields_when_disabled_via_logger_parameter() {
    ...
    System.Assert.isNull(logEntryEvent.LimitsApexCursorRowsUsed__c);
    ...
    System.Assert.isNull(logEntryEvent.LimitsApexCursorFetchCallsUsed__c);
    ...
    System.Assert.isNull(logEntryEvent.LimitsApexCursorRowsMax__c);
    ...
    System.Assert.isNull(logEntryEvent.LimitsApexCursorFetchCallsMax__c);
  ...
  @IsTest
  static void it_should_properly_truncate_loooooong_message_when_data_mask_rule_is_applied() {
    LoggerSettings__c userSettings = getUserSettings();
    userSettings.IsDataMaskingEnabled__c = true;
    LogEntryDataMaskRule__mdt rule = getSocialSecurityNumberDataMaskRule();
    rule.IsEnabled__c = true;
    ...
    String sensitiveStringThatWillBeExpandedByDataMasking =
      'Here is my fake social 400119999. Since it doesn\'t have dashes or spaces, and the regex will add dashes, the resulting string would have been too long in previous releases. ' +
      'A'.repeat(fieldMaxLength);
    String expectedSanitizedString =
      'Here is my fake social XXX-XX-9999. Since it doesn\'t have dashes or spaces, and the regex will add dashes, the resulting string would have been too long in previous releases. ' +
      'A'.repeat(fieldMaxLength);
    System.Assert.isTrue(
      expectedSanitizedString.length() > sensitiveStringThatWillBeExpandedByDataMasking.length(),
      'Test has started under the wrong conditions!'
    );

    LogEntryEventBuilder builder = new LogEntryEventBuilder(userSettings, System.LoggingLevel.INFO, true);
    builder.setMessage(sensitiveStringThatWillBeExpandedByDataMasking);

    System.Assert.isTrue(builder.getLogEntryEvent().MessageMasked__c);
    System.Assert.isTrue(builder.getLogEntryEvent().MessageTruncated__c);
    System.Assert.areNotEqual(sensitiveStringThatWillBeExpandedByDataMasking, builder.getLogEntryEvent().Message__c);
    System.Assert.areEqual(expectedSanitizedString.left(fieldMaxLength), builder.getLogEntryEvent().Message__c);
    System.Assert.areEqual(fieldMaxLength, builder.getLogEntryEvent().Message__c.length());
  }
  ...
  @IsTest
  static void it_should_properly_truncate_loooooong_record_json_when_data_mask_rule_is_applied() {
    LoggerSettings__c userSettings = getUserSettings();
    userSettings.IsDataMaskingEnabled__c = true;
    LogEntryDataMaskRule__mdt rule = getSocialSecurityNumberDataMaskRule();
    rule.IsEnabled__c = true;
    LogEntryEventBuilder.setMockDataMaskRule(rule);
    Integer fieldMaxLength = LogEntryEvent__e.RecordJson__c.getDescribe().getLength();
    String sensitiveStringThatWillBeExpandedByDataMasking =
      'Here is my fake social 400119999. Since it doesn\'t have dashes or spaces, and the regex will add dashes, the resulting string would have been too long in previous releases. ' +
      'A'.repeat(fieldMaxLength);
    String expectedSanitizedString =
    ...
    Schema.Account account = new Schema.Account(Name = sensitiveStringThatWillBeExpandedByDataMasking);
    String expectedSanitizedAccountJson = System.JSON.serializePretty(new Schema.Account(Name = expectedSanitizedString));
    ...
    System.Assert.isTrue(builder.getLogEntryEvent().RecordJsonMasked__c);
    System.Assert.isTrue(builder.getLogEntryEvent().RecordJsonTruncated__c);
    System.Assert.areNotEqual(sensitiveStringThatWillBeExpandedByDataMasking, builder.getLogEntryEvent().RecordJson__c);
    System.Assert.areEqual(expectedSanitizedAccountJson.left(fieldMaxLength), builder.getLogEntryEvent().RecordJson__c);
    System.Assert.areEqual(fieldMaxLength, builder.getLogEntryEvent().RecordJson__c.length());
  }
  ...
  @IsTest
  static void it_should_properly_truncate_loooooong_record_list_json_when_data_mask_rule_is_applied() {
    LoggerSettings__c userSettings = getUserSettings();
    userSettings.IsDataMaskingEnabled__c = true;
    LogEntryDataMaskRule__mdt rule = getSocialSecurityNumberDataMaskRule();
    rule.IsEnabled__c = true;
    ...
    List<Schema.Account> accounts = new List<Schema.Account>{ new Schema.Account(Name = sensitiveStringThatWillBeExpandedByDataMasking) };
    String expectedSanitizedAccountListJson = System.JSON.serializePretty(new List<Schema.Account>{ new Schema.Account(Name = expectedSanitizedString) });
    ...
    System.Assert.isTrue(builder.getLogEntryEvent().RecordJsonTruncated__c);
    System.Assert.areNotEqual(sensitiveStringThatWillBeExpandedByDataMasking, builder.getLogEntryEvent().RecordJson__c);
    System.Assert.areEqual(expectedSanitizedAccountListJson.left(fieldMaxLength), builder.getLogEntryEvent().RecordJson__c);
    System.Assert.areEqual(fieldMaxLength, builder.getLogEntryEvent().RecordJson__c.length());
  }

  @IsTest
  static void it_should_apply_data_mask_rule_to_record_map_json_when_enabled() {
    LoggerSettings__c userSettings = getUserSettings();
    userSettings.IsDataMaskingEnabled__c = true;
    LogEntryDataMaskRule__mdt rule = getSocialSecurityNumberDataMaskRule();
    rule.IsEnabled__c = true;
    ...
    String sensitiveString = 'Something, something, and my social is 400 11 9999 in case you want to steal my identity';
    String expectedSanitizedString = 'Something, something, and my social is XXX-XX-9999 in case you want to steal my identity';
    Id mockAccountId = LoggerMockDataCreator.createId(Schema.Account.SObjectType);
    Map<Id, Schema.Account> accountIdToAccount = new Map<Id, Schema.Account>{ mockAccountId => new Schema.Account(Name = sensitiveString) };
    String accountMapJson = System.JSON.serializePretty(accountIdToAccount);
    String expectedSanitizedAccountMapJson = System.JSON.serializePretty(
      new Map<Id, Schema.Account>{ mockAccountId => new Schema.Account(Name = expectedSanitizedString) }
    );

    LogEntryEventBuilder builder = new LogEntryEventBuilder(userSettings, System.LoggingLevel.INFO, true);
    builder.setRecord(accountIdToAccount);

    System.Assert.isTrue(builder.getLogEntryEvent().RecordJsonMasked__c);
    System.Assert.areNotEqual(accountMapJson, builder.getLogEntryEvent().RecordJson__c);
    System.Assert.areEqual(expectedSanitizedAccountMapJson, builder.getLogEntryEvent().RecordJson__c);
  }

  @IsTest
  static void it_should_properly_truncate_loooooong_record_map_json_when_data_mask_rule_is_applied() {
    LoggerSettings__c userSettings = getUserSettings();
    userSettings.IsDataMaskingEnabled__c = true;
    LogEntryDataMaskRule__mdt rule = getSocialSecurityNumberDataMaskRule();
    rule.IsEnabled__c = true;
    ...
    Id mockAccountId = LoggerMockDataCreator.createId(Schema.Account.SObjectType);
    Map<Id, Schema.Account> accountIdToAccount = new Map<Id, Schema.Account>{
      mockAccountId => new Schema.Account(Name = sensitiveStringThatWillBeExpandedByDataMasking)
    };
    String expectedSanitizedAccountMapJson = System.JSON.serializePretty(
      new Map<Id, Schema.Account>{ mockAccountId => new Schema.Account(Name = expectedSanitizedString) }
    );
    ...
    System.Assert.isTrue(builder.getLogEntryEvent().RecordJsonTruncated__c);
    System.Assert.areNotEqual(sensitiveStringThatWillBeExpandedByDataMasking, builder.getLogEntryEvent().RecordJson__c);
    System.Assert.areEqual(expectedSanitizedAccountMapJson.left(fieldMaxLength), builder.getLogEntryEvent().RecordJson__c);
    System.Assert.areEqual(fieldMaxLength, builder.getLogEntryEvent().RecordJson__c.length());
  }
  ...
  @IsTest
  static void it_should_properly_truncate_loooooong_record_http_request_body_when_data_mask_rule_is_applied() {
    LoggerSettings__c userSettings = getUserSettings();
    userSettings.IsDataMaskingEnabled__c = true;
    LogEntryDataMaskRule__mdt rule = getSocialSecurityNumberDataMaskRule();
    rule.IsEnabled__c = true;
    LogEntryEventBuilder.setMockDataMaskRule(rule);
    Integer fieldMaxLength = LogEntryEvent__e.HttpRequestBody__c.getDescribe().getLength();
    String sensitiveStringThatWillBeExpandedByDataMasking =
      'Here is my fake social 400119999. Since it doesn\'t have dashes or spaces, and the regex will add dashes, the resulting string would have been too long in previous releases. ' +
      'A'.repeat(fieldMaxLength);
    String expectedSanitizedString =
    ...
    System.HttpRequest httpRequest = LoggerMockDataCreator.createHttpRequest();
    httpRequest.setBody(sensitiveStringThatWillBeExpandedByDataMasking);

    LogEntryEventBuilder builder = new LogEntryEventBuilder(userSettings, System.LoggingLevel.INFO, true);
    builder.setHttpRequestDetails(httpRequest);

    System.Assert.isTrue(builder.getLogEntryEvent().HttpRequestBodyMasked__c);
    System.Assert.isTrue(builder.getLogEntryEvent().HttpRequestBodyTruncated__c);
    System.Assert.areNotEqual(sensitiveStringThatWillBeExpandedByDataMasking, builder.getLogEntryEvent().HttpRequestBody__c);
    System.Assert.areEqual(expectedSanitizedString.left(fieldMaxLength), builder.getLogEntryEvent().HttpRequestBody__c);
    System.Assert.areEqual(fieldMaxLength, builder.getLogEntryEvent().HttpRequestBody__c.length());
  }
  ...
  @IsTest
  static void it_should_properly_truncate_loooooong_record_http_response_body_when_data_mask_rule_is_applied() {
    LoggerSettings__c userSettings = getUserSettings();
    userSettings.IsDataMaskingEnabled__c = true;
    LogEntryDataMaskRule__mdt rule = getSocialSecurityNumberDataMaskRule();
    rule.IsEnabled__c = true;
    LogEntryEventBuilder.setMockDataMaskRule(rule);
    Integer fieldMaxLength = LogEntryEvent__e.HttpResponseBody__c.getDescribe().getLength();
    String sensitiveStringThatWillBeExpandedByDataMasking =
      'Here is my fake social 400119999. Since it doesn\'t have dashes or spaces, and the regex will add dashes, the resulting string would have been too long in previous releases. ' +
      'A'.repeat(fieldMaxLength);
    String expectedSanitizedString =
    ...
    System.HttpResponse httpResponse = LoggerMockDataCreator.createHttpResponse();
    httpResponse.setBody(sensitiveStringThatWillBeExpandedByDataMasking);

    LogEntryEventBuilder builder = new LogEntryEventBuilder(userSettings, System.LoggingLevel.INFO, true);
    builder.setHttpResponseDetails(httpResponse);

    System.Assert.isTrue(builder.getLogEntryEvent().HttpResponseBodyMasked__c);
    System.Assert.isTrue(builder.getLogEntryEvent().HttpResponseBodyTruncated__c);
    System.Assert.areNotEqual(sensitiveStringThatWillBeExpandedByDataMasking, builder.getLogEntryEvent().HttpResponseBody__c);
    System.Assert.areEqual(expectedSanitizedString.left(fieldMaxLength), builder.getLogEntryEvent().HttpResponseBody__c);
    System.Assert.areEqual(fieldMaxLength, builder.getLogEntryEvent().HttpResponseBody__c.length());
  }
  ...
  @IsTest
  static void it_should_properly_truncate_loooooong_record_rest_request_body_when_data_mask_rule_is_applied() {
    LoggerSettings__c userSettings = getUserSettings();
    userSettings.IsDataMaskingEnabled__c = true;
    LogEntryDataMaskRule__mdt rule = getSocialSecurityNumberDataMaskRule();
    rule.IsEnabled__c = true;
    LogEntryEventBuilder.setMockDataMaskRule(rule);
    Integer fieldMaxLength = LogEntryEvent__e.RestRequestBody__c.getDescribe().getLength();
    String sensitiveStringThatWillBeExpandedByDataMasking =
      'Here is my fake social 400119999. Since it doesn\'t have dashes or spaces, and the regex will add dashes, the resulting string would have been too long in previous releases. ' +
      'A'.repeat(fieldMaxLength);
    String expectedSanitizedString =
    ...
    System.RestRequest restRequest = new System.RestRequest();
    restRequest.requestBody = Blob.valueOf(sensitiveStringThatWillBeExpandedByDataMasking);

    LogEntryEventBuilder builder = new LogEntryEventBuilder(userSettings, System.LoggingLevel.INFO, true);
    builder.setRestRequestDetails(restRequest);

    System.Assert.isTrue(builder.getLogEntryEvent().RestRequestBodyMasked__c);
    System.Assert.isTrue(builder.getLogEntryEvent().RestRequestBodyTruncated__c);
    System.Assert.areNotEqual(sensitiveStringThatWillBeExpandedByDataMasking, builder.getLogEntryEvent().RestRequestBody__c);
    System.Assert.areEqual(expectedSanitizedString.left(fieldMaxLength), builder.getLogEntryEvent().RestRequestBody__c);
    System.Assert.areEqual(fieldMaxLength, builder.getLogEntryEvent().RestRequestBody__c.length());
  }
  ...
  @IsTest
  static void it_should_properly_truncate_loooooong_record_rest_response_body_when_data_mask_rule_is_applied() {
    LoggerSettings__c userSettings = getUserSettings();
    userSettings.IsDataMaskingEnabled__c = true;
    LogEntryDataMaskRule__mdt rule = getSocialSecurityNumberDataMaskRule();
    rule.IsEnabled__c = true;
    LogEntryEventBuilder.setMockDataMaskRule(rule);
    Integer fieldMaxLength = LogEntryEvent__e.RestResponseBody__c.getDescribe().getLength();
    String sensitiveStringThatWillBeExpandedByDataMasking =
      'Here is my fake social 400119999. Since it doesn\'t have dashes or spaces, and the regex will add dashes, the resulting string would have been too long in previous releases. ' +
      'A'.repeat(fieldMaxLength);
    String expectedSanitizedString =
    ...
    System.RestResponse restResponse = new System.RestResponse();
    restResponse.responseBody = Blob.valueOf(sensitiveStringThatWillBeExpandedByDataMasking);

    LogEntryEventBuilder builder = new LogEntryEventBuilder(userSettings, System.LoggingLevel.INFO, true);
    builder.setRestResponseDetails(restResponse);

    System.Assert.isTrue(builder.getLogEntryEvent().RestResponseBodyMasked__c);
    System.Assert.isTrue(builder.getLogEntryEvent().RestResponseBodyTruncated__c);
    System.Assert.areNotEqual(sensitiveStringThatWillBeExpandedByDataMasking, builder.getLogEntryEvent().RestResponseBody__c);
    System.Assert.areEqual(expectedSanitizedString.left(fieldMaxLength), builder.getLogEntryEvent().RestResponseBody__c);
    System.Assert.areEqual(fieldMaxLength, builder.getLogEntryEvent().RestResponseBody__c.length());
  }
  ...
  @IsTest
  static void it_should_set_database_result_fields_for_approval_lockResult() {
    Approval.LockResult lockResult = LoggerMockDataCreator.createApprovalLockResult(true);
    System.Assert.isNotNull(lockResult);

    LogEntryEventBuilder builder = new LogEntryEventBuilder(getUserSettings(), System.LoggingLevel.INFO, true);
    builder.setApprovalResult(lockResult);
    ...
    System.Assert.areEqual(System.JSON.serializePretty(lockResult), builder.getLogEntryEvent().DatabaseResultJson__c);
    System.Assert.areEqual(Approval.LockResult.class.getName(), builder.getLogEntryEvent().DatabaseResultType__c);
  }

  @IsTest
  static void it_should_set_database_result_fields_for_approval_processResult() {
    Approval.ProcessResult processResult = LoggerMockDataCreator.createApprovalProcessResult(true);
    System.Assert.isNotNull(processResult);

    LogEntryEventBuilder builder = new LogEntryEventBuilder(getUserSettings(), System.LoggingLevel.INFO, true);
    builder.setApprovalResult(processResult);

    System.Assert.areEqual(1, builder.getLogEntryEvent().DatabaseResultCollectionSize__c);
    System.Assert.areEqual('Single', builder.getLogEntryEvent().DatabaseResultCollectionType__c);
    System.Assert.areEqual(System.JSON.serializePretty(processResult), builder.getLogEntryEvent().DatabaseResultJson__c);
    System.Assert.areEqual(Approval.ProcessResult.class.getName(), builder.getLogEntryEvent().DatabaseResultType__c);
  }

  @IsTest
  static void it_should_set_database_result_fields_for_approval_unlockResult() {
    Approval.UnlockResult unlockResult = LoggerMockDataCreator.createApprovalUnlockResult(true);
    System.Assert.isNotNull(unlockResult);

    LogEntryEventBuilder builder = new LogEntryEventBuilder(getUserSettings(), System.LoggingLevel.INFO, true);
    builder.setApprovalResult(unlockResult);

    System.Assert.areEqual(1, builder.getLogEntryEvent().DatabaseResultCollectionSize__c);
    System.Assert.areEqual('Single', builder.getLogEntryEvent().DatabaseResultCollectionType__c);
    System.Assert.areEqual(System.JSON.serializePretty(unlockResult), builder.getLogEntryEvent().DatabaseResultJson__c);
    System.Assert.areEqual(Approval.UnlockResult.class.getName(), builder.getLogEntryEvent().DatabaseResultType__c);
  }

  @IsTest
  static void it_should_set_database_result_fields_for_list_of_approval_lockResult() {
    List<Approval.LockResult> lockResults = new List<Approval.LockResult>();
    for (Integer i = 0; i < 5; i++) {
      lockResults.add(LoggerMockDataCreator.createApprovalLockResult(false));
    }

    LogEntryEventBuilder builder = new LogEntryEventBuilder(getUserSettings(), System.LoggingLevel.INFO, true);
    builder.setApprovalResult(lockResults);

    System.Assert.areEqual(lockResults.size(), builder.getLogEntryEvent().DatabaseResultCollectionSize__c);
    System.Assert.areEqual('List', builder.getLogEntryEvent().DatabaseResultCollectionType__c);
    System.Assert.areEqual(System.JSON.serializePretty(lockResults), builder.getLogEntryEvent().DatabaseResultJson__c);
    System.Assert.areEqual(Approval.LockResult.class.getName(), builder.getLogEntryEvent().DatabaseResultType__c);
  }

  @IsTest
  static void it_should_set_database_result_fields_for_list_of_approval_processResult() {
    List<Approval.ProcessResult> processResults = new List<Approval.ProcessResult>();
    for (Integer i = 0; i < 5; i++) {
      processResults.add(LoggerMockDataCreator.createApprovalProcessResult(false));
    }

    LogEntryEventBuilder builder = new LogEntryEventBuilder(getUserSettings(), System.LoggingLevel.INFO, true);
    builder.setApprovalResult(processResults);

    System.Assert.areEqual(processResults.size(), builder.getLogEntryEvent().DatabaseResultCollectionSize__c);
    System.Assert.areEqual('List', builder.getLogEntryEvent().DatabaseResultCollectionType__c);
    System.Assert.areEqual(System.JSON.serializePretty(processResults), builder.getLogEntryEvent().DatabaseResultJson__c);
    System.Assert.areEqual(Approval.ProcessResult.class.getName(), builder.getLogEntryEvent().DatabaseResultType__c);
  }

  @IsTest
  static void it_should_set_database_result_fields_for_list_of_approval_unlockResult() {
    List<Approval.UnlockResult> unlockResults = new List<Approval.UnlockResult>();
    for (Integer i = 0; i < 5; i++) {
      unlockResults.add(LoggerMockDataCreator.createApprovalUnlockResult(false));
    }

    LogEntryEventBuilder builder = new LogEntryEventBuilder(getUserSettings(), System.LoggingLevel.INFO, true);
    builder.setApprovalResult(unlockResults);

    System.Assert.areEqual(unlockResults.size(), builder.getLogEntryEvent().DatabaseResultCollectionSize__c);
    System.Assert.areEqual('List', builder.getLogEntryEvent().DatabaseResultCollectionType__c);
    System.Assert.areEqual(System.JSON.serializePretty(unlockResults), builder.getLogEntryEvent().DatabaseResultJson__c);
    System.Assert.areEqual(Approval.UnlockResult.class.getName(), builder.getLogEntryEvent().DatabaseResultType__c);
  }
  ...
  @IsTest
  static void it_should_set_database_result_fields_for_emptyRecycleBinResult() {
    Database.EmptyRecycleBinResult emptyRecycleBinResult = LoggerMockDataCreator.createDatabaseEmptyRecycleBinResult(true);
    System.Assert.isNotNull(emptyRecycleBinResult);

    LogEntryEventBuilder builder = new LogEntryEventBuilder(getUserSettings(), System.LoggingLevel.INFO, true);
    builder.setDatabaseResult(emptyRecycleBinResult);

    System.Assert.areEqual(1, builder.getLogEntryEvent().DatabaseResultCollectionSize__c);
    System.Assert.areEqual('Single', builder.getLogEntryEvent().DatabaseResultCollectionType__c);
    System.Assert.areEqual(System.JSON.serializePretty(emptyRecycleBinResult), builder.getLogEntryEvent().DatabaseResultJson__c);
    System.Assert.areEqual(Database.EmptyRecycleBinResult.class.getName(), builder.getLogEntryEvent().DatabaseResultType__c);
  }
  ...
  @IsTest
  static void it_should_set_database_result_fields_for_list_of_emptyRecycleBinResult() {
    List<Database.EmptyRecycleBinResult> emptyRecycleBinResults = new List<Database.EmptyRecycleBinResult>();
    for (Integer i = 0; i < 5; i++) {
      emptyRecycleBinResults.add(LoggerMockDataCreator.createDatabaseEmptyRecycleBinResult(false));
    }

    LogEntryEventBuilder builder = new LogEntryEventBuilder(getUserSettings(), System.LoggingLevel.INFO, true);
    builder.setDatabaseResult(emptyRecycleBinResults);

    System.Assert.areEqual(emptyRecycleBinResults.size(), builder.getLogEntryEvent().DatabaseResultCollectionSize__c);
    System.Assert.areEqual('List', builder.getLogEntryEvent().DatabaseResultCollectionType__c);
    System.Assert.areEqual(System.JSON.serializePretty(emptyRecycleBinResults), builder.getLogEntryEvent().DatabaseResultJson__c);
    System.Assert.areEqual(Database.EmptyRecycleBinResult.class.getName(), builder.getLogEntryEvent().DatabaseResultType__c);
  }
  ...
  static void it_should_set_record_fields_for_recordId_when_custom_object() {
    ...
    System.Assert.areEqual(Log__c.SObjectType.toString(), builder.getLogEntryEvent().RecordSObjectType__c);
  }
  ...
  static void it_should_set_record_fields_for_recordId_when_custom_metadata_type() {
    ...
    System.Assert.areEqual(LogStatus__mdt.SObjectType.toString(), builder.getLogEntryEvent().RecordSObjectType__c);
  }
  ...
  static void it_should_set_record_fields_for_list_of_records_when_populated() {
    ...
    System.Assert.areEqual(System.JSON.serializePretty(users), builder.getLogEntryEvent().RecordJson__c);
    System.Assert.areEqual('Standard Object', builder.getLogEntryEvent().RecordSObjectClassification__c);
    System.Assert.areEqual(Schema.User.SObjectType.toString(), builder.getLogEntryEvent().RecordSObjectType__c);
  }
  ...
  static void it_should_set_save_reason_when_user_logging_level_met() {
    ...
    System.Assert.isTrue(builder.shouldSave());
    System.Assert.areEqual('Logging Level Met', builder.getLogEntryEvent().EntrySaveReason__c);
  }
  ...
  static void it_should_set_save_reason_when_entry_saving_is_overridden() {
    ...
    System.Assert.isTrue(builder.shouldSave());
    System.Assert.areEqual('Save Overridden', builder.getLogEntryEvent().EntrySaveReason__c);
  }
  ...
  static LogEntryDataMaskRule__mdt getSocialSecurityNumberDataMaskRule() {
    return new LogEntryDataMaskRule__mdt(
      ...
      IsEnabled__c = true,
      SensitiveDataRegEx__c = '(?<!\\d)(\\d{3})[- ]?(\\d{2})[- ]?(\\d{4})(?!\\d)',
...
## Methods
### `it_should_short_circuit_when_disabled()`

`ISTEST`

#### Signature
```apex
private static void it_should_short_circuit_when_disabled()
```
...
### `it_should_short_circuit_when_enabled_logging_level_above_called_level()`

`ISTEST`

#### Signature
```apex
private static void it_should_short_circuit_when_enabled_logging_level_above_called_level()
```
...
### `it_should_not_short_circuit_when_enabled()`

`ISTEST`

#### Signature
```apex
private static void it_should_not_short_circuit_when_enabled()
```
...
### `it_should_not_run_queries_when_logging_is_disabled_via_logger_settings()`

`ISTEST`

#### Signature
```apex
private static void it_should_not_run_queries_when_logging_is_disabled_via_logger_settings()
```
...
#### Signature
```apex
private static void it_should_set_transaction_limits_fields_when_enabled_via_logger_parameter()
```
...
### `it_should_not_set_transaction_heap_limits_fields_when_disabled_via_logger_parameter()`

`ISTEST`

#### Signature
```apex
private static void it_should_not_set_transaction_heap_limits_fields_when_disabled_via_logger_parameter()
```
...
### `it_should_not_set_transaction_heap_limits_fields_when_transaction_limit_tracking_is_disabled_via_logger_parameter()`

`ISTEST`

#### Signature
```apex
private static void it_should_not_set_transaction_heap_limits_fields_when_transaction_limit_tracking_is_disabled_via_logger_parameter()
```
...
### `it_should_not_set_transaction_limits_fields_when_disabled_via_logger_parameter()`

`ISTEST`

#### Signature
```apex
private static void it_should_not_set_transaction_limits_fields_when_disabled_via_logger_parameter()
```
...
### `it_should_not_run_authSession_query_when_disabled_via_logger_parameter()`

`ISTEST`

#### Signature
```apex
private static void it_should_not_run_authSession_query_when_disabled_via_logger_parameter()
```
...
#### Signature
```apex
private static void it_should_run_authSession_query_when_enabled_via_logger_parameter()
```
...
### `it_should_query_and_handle_authSession_when_logingHistory_is_null()`

`ISTEST`

#### Signature
```apex
private static void it_should_query_and_handle_authSession_when_logingHistory_is_null()
```
...
### `it_should_not_run_organization_query_when_disabled_via_logger_parameter()`

`ISTEST`

#### Signature
```apex
private static void it_should_not_run_organization_query_when_disabled_via_logger_parameter()
```
...
#### Signature
```apex
private static void it_should_run_organization_query_when_enabled_via_logger_parameter()
```
...
### `it_should_not_run_user_query_when_disabled_via_logger_parameter()`

`ISTEST`

#### Signature
```apex
private static void it_should_not_run_user_query_when_disabled_via_logger_parameter()
```
...
#### Signature
```apex
private static void it_should_run_user_query_when_enabled_via_logger_parameter()
```
...
### `it_should_set_message_fields_for_logMessage()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_message_fields_for_logMessage()
```
...
### `it_should_set_message_fields_for_null_logMessage()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_message_fields_for_null_logMessage()
```
...
### `it_should_set_message_fields_for_string()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_message_fields_for_string()
```
...
### `it_should_set_message_fields_for_null_string()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_message_fields_for_null_string()
```
...
### `it_should_truncate_message_field_when_string_is_too_long()`

`ISTEST`

#### Signature
```apex
private static void it_should_truncate_message_field_when_string_is_too_long()
```
...
### `it_should_not_apply_data_mask_rule_when_rule_disabled()`

`ISTEST`

#### Signature
```apex
private static void it_should_not_apply_data_mask_rule_when_rule_disabled()
```
...
### `it_should_not_apply_data_mask_rule_when_disabled_for_user()`

`ISTEST`

#### Signature
```apex
private static void it_should_not_apply_data_mask_rule_when_disabled_for_user()
```
...
### `it_should_apply_data_mask_rule_to_message_when_enabled()`

`ISTEST`

#### Signature
```apex
private static void it_should_apply_data_mask_rule_to_message_when_enabled()
```
...
### `it_should_properly_truncate_loooooong_message_when_data_mask_rule_is_applied()`

`ISTEST`

#### Signature
```apex
private static void it_should_properly_truncate_loooooong_message_when_data_mask_rule_is_applied()
```
...
### `it_should_apply_data_mask_rule_to_record_json_when_enabled()`

`ISTEST`

#### Signature
```apex
private static void it_should_apply_data_mask_rule_to_record_json_when_enabled()
```
...
### `it_should_properly_truncate_loooooong_record_json_when_data_mask_rule_is_applied()`

`ISTEST`

#### Signature
```apex
private static void it_should_properly_truncate_loooooong_record_json_when_data_mask_rule_is_applied()
```
...
### `it_should_apply_data_mask_rule_to_record_list_json_when_enabled()`

`ISTEST`

#### Signature
```apex
private static void it_should_apply_data_mask_rule_to_record_list_json_when_enabled()
```
...
### `it_should_properly_truncate_loooooong_record_list_json_when_data_mask_rule_is_applied()`

`ISTEST`

#### Signature
```apex
private static void it_should_properly_truncate_loooooong_record_list_json_when_data_mask_rule_is_applied()
```
...
### `it_should_apply_data_mask_rule_to_record_map_json_when_enabled()`

`ISTEST`

#### Signature
```apex
private static void it_should_apply_data_mask_rule_to_record_map_json_when_enabled()
```
...
### `it_should_properly_truncate_loooooong_record_map_json_when_data_mask_rule_is_applied()`

`ISTEST`

#### Signature
```apex
private static void it_should_properly_truncate_loooooong_record_map_json_when_data_mask_rule_is_applied()
```
...
### `it_should_apply_data_mask_rule_to_http_request_body_when_enabled()`

`ISTEST`

#### Signature
```apex
private static void it_should_apply_data_mask_rule_to_http_request_body_when_enabled()
```
...
### `it_should_properly_truncate_loooooong_record_http_request_body_when_data_mask_rule_is_applied()`

`ISTEST`

#### Signature
```apex
private static void it_should_properly_truncate_loooooong_record_http_request_body_when_data_mask_rule_is_applied()
```
...
### `it_should_apply_data_mask_rule_to_http_response_body_when_enabled()`

`ISTEST`

#### Signature
```apex
private static void it_should_apply_data_mask_rule_to_http_response_body_when_enabled()
```
...
### `it_should_properly_truncate_loooooong_record_http_response_body_when_data_mask_rule_is_applied()`

`ISTEST`

#### Signature
```apex
private static void it_should_properly_truncate_loooooong_record_http_response_body_when_data_mask_rule_is_applied()
```
...
### `it_should_apply_data_mask_rule_to_rest_request_body_when_enabled()`

`ISTEST`

#### Signature
```apex
private static void it_should_apply_data_mask_rule_to_rest_request_body_when_enabled()
```
...
### `it_should_properly_truncate_loooooong_record_rest_request_body_when_data_mask_rule_is_applied()`

`ISTEST`

#### Signature
```apex
private static void it_should_properly_truncate_loooooong_record_rest_request_body_when_data_mask_rule_is_applied()
```
...
### `it_should_apply_data_mask_rule_to_rest_response_body_when_enabled()`

`ISTEST`

#### Signature
```apex
private static void it_should_apply_data_mask_rule_to_rest_response_body_when_enabled()
```
...
### `it_should_properly_truncate_loooooong_record_rest_response_body_when_data_mask_rule_is_applied()`

`ISTEST`

#### Signature
```apex
private static void it_should_properly_truncate_loooooong_record_rest_response_body_when_data_mask_rule_is_applied()
```
...
### `it_should_truncate_message_for_long_logMessage()`

`ISTEST`

#### Signature
```apex
private static void it_should_truncate_message_for_long_logMessage()
```
...
### `it_should_truncate_message_for_long_string()`

`ISTEST`

#### Signature
```apex
private static void it_should_truncate_message_for_long_string()
```
...
### `it_should_skip_setting_exception_fields_when_exception_is_null()`

`ISTEST`

#### Signature
```apex
private static void it_should_skip_setting_exception_fields_when_exception_is_null()
```
...
### `it_should_set_exception_fields_for_dmlException()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_exception_fields_for_dmlException()
```
...
### `it_should_set_database_result_fields_for_approval_lockResult()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_database_result_fields_for_approval_lockResult()
```
...
### `it_should_set_database_result_fields_for_approval_processResult()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_database_result_fields_for_approval_processResult()
```
...
### `it_should_set_database_result_fields_for_approval_unlockResult()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_database_result_fields_for_approval_unlockResult()
```
...
### `it_should_set_database_result_fields_for_list_of_approval_lockResult()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_database_result_fields_for_list_of_approval_lockResult()
```
...
### `it_should_set_database_result_fields_for_list_of_approval_processResult()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_database_result_fields_for_list_of_approval_processResult()
```
...
### `it_should_set_database_result_fields_for_list_of_approval_unlockResult()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_database_result_fields_for_list_of_approval_unlockResult()
```
...
### `it_should_set_database_result_fields_for_deleteResult()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_database_result_fields_for_deleteResult()
```
...
### `it_should_set_database_result_fields_for_emptyRecycleBinResult()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_database_result_fields_for_emptyRecycleBinResult()
```
...
### `it_should_set_database_result_fields_for_leadConvertResult()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_database_result_fields_for_leadConvertResult()
```
...
### `it_should_set_database_result_fields_for_mergeResult()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_database_result_fields_for_mergeResult()
```
...
### `it_should_set_database_result_fields_for_saveResult()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_database_result_fields_for_saveResult()
```
...
### `it_should_set_database_result_fields_for_undeleteResult()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_database_result_fields_for_undeleteResult()
```
...
### `it_should_set_database_result_fields_for_upsertResult_when_insert()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_database_result_fields_for_upsertResult_when_insert()
```
...
### `it_should_set_database_result_fields_for_upsertResult_when_update()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_database_result_fields_for_upsertResult_when_update()
```
...
### `it_should_set_database_result_fields_for_list_of_deleteResult()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_database_result_fields_for_list_of_deleteResult()
```
...
### `it_should_set_database_result_fields_for_list_of_emptyRecycleBinResult()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_database_result_fields_for_list_of_emptyRecycleBinResult()
```
...
### `it_should_set_database_result_fields_for_list_of_leadConvertResult()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_database_result_fields_for_list_of_leadConvertResult()
```
...
### `it_should_set_database_result_fields_for_list_of_mergeResult()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_database_result_fields_for_list_of_mergeResult()
```
...
### `it_should_set_database_result_fields_for_list_of_saveResult()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_database_result_fields_for_list_of_saveResult()
```
...
### `it_should_set_database_result_fields_for_list_of_undeleteResult()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_database_result_fields_for_list_of_undeleteResult()
```
...
### `it_should_set_database_result_fields_for_list_of_upsertResult()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_database_result_fields_for_list_of_upsertResult()
```
...
### `it_should_set_record_fields_for_recordId_when_standard_object()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_record_fields_for_recordId_when_standard_object()
```
...
#### Signature
```apex
private static void it_should_set_record_fields_for_recordId_when_template_standard_object()
```
...
#### Signature
```apex
private static void it_should_set_record_fields_for_recordId_when_custom_object()
```
...
### `it_should_set_record_fields_for_recordId_when_custom_metadata_type()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_record_fields_for_recordId_when_custom_metadata_type()
```
...
#### Signature
```apex
private static void it_should_set_record_fields_for_record_when_null()
```
...
### `it_should_set_record_fields_for_record_when_standard_object()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_record_fields_for_record_when_standard_object()
```
...
### `it_should_set_record_fields_for_record_when_custom_object()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_record_fields_for_record_when_custom_object()
```
...
### `it_should_set_record_fields_for_record_when_custom_metadata_type()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_record_fields_for_record_when_custom_metadata_type()
```
...
### `it_should_set_record_fields_for_record_when_platform_event()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_record_fields_for_record_when_platform_event()
```
...
### `it_should_skip_stripping_inaccessible_fields_for_aggregate_result()`

`ISTEST`

#### Signature
```apex
private static void it_should_skip_stripping_inaccessible_fields_for_aggregate_result()
```
...
### `it_should_skip_stripping_inaccessible_fields_for_aggregate_results()`

`ISTEST`

#### Signature
```apex
private static void it_should_skip_stripping_inaccessible_fields_for_aggregate_results()
```
...
#### Signature
```apex
private static void it_should_set_record_fields_for_list_of_records_when_list_is_null()
```
...
### `it_should_set_record_fields_for_list_of_records_when_list_is_empty()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_record_fields_for_list_of_records_when_list_is_empty()
```
...
### `it_should_set_record_fields_for_list_of_records_when_first_record_is_null()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_record_fields_for_list_of_records_when_first_record_is_null()
```
...
### `it_should_set_record_fields_for_list_of_records_when_populated()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_record_fields_for_list_of_records_when_populated()
```
...
#### Signature
```apex
private static void it_should_set_record_fields_for_map_of_sobject_records_when_map_is_null()
```
...
### `it_should_set_record_fields_for_map_of_sobject_records_when_map_is_empty()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_record_fields_for_map_of_sobject_records_when_map_is_empty()
```
...
### `it_should_set_record_fields_for_map_of_sobject_records_when_map_contains_null_key()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_record_fields_for_map_of_sobject_records_when_map_contains_null_key()
```
...
### `it_should_set_record_fields_for_map_of_sobject_records_when_first_record_is_null()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_record_fields_for_map_of_sobject_records_when_first_record_is_null()
```
...
### `it_should_set_record_fields_for_map_of_user_records_when_populated()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_record_fields_for_map_of_user_records_when_populated()
```
...
#### Signature
```apex
private static void it_should_set_record_fields_for_iterable_ids_when_null()
```
...
### `it_should_set_record_fields_for_list_of_id_records_when_populated()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_record_fields_for_list_of_id_records_when_populated()
```
...
### `it_should_set_record_fields_for_set_of_id_records_when_populated()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_record_fields_for_set_of_id_records_when_populated()
```
...
### `it_should_skip_setting_http_request_fields_when_request_is_null()`

`ISTEST`

#### Signature
```apex
private static void it_should_skip_setting_http_request_fields_when_request_is_null()
```
...
### `it_should_set_http_request_fields_when_request_is_populated()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_http_request_fields_when_request_is_populated()
```
...
### `it_should_set_http_request_fields_when_header_keys_are_provided_and_storing_header_values_is_enabled()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_http_request_fields_when_header_keys_are_provided_and_storing_header_values_is_enabled()
```
...
### `it_should_set_http_request_fields_when_header_keys_are_provided_and_storing_header_values_is_disabled()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_http_request_fields_when_header_keys_are_provided_and_storing_header_values_is_disabled()
```
...
### `it_should_truncate_http_request_body_field_when_string_is_too_long()`

`ISTEST`

#### Signature
```apex
private static void it_should_truncate_http_request_body_field_when_string_is_too_long()
```
...
### `it_should_skip_setting_http_response_fields_when_response_is_null()`

`ISTEST`

#### Signature
```apex
private static void it_should_skip_setting_http_response_fields_when_response_is_null()
```
...
### `it_should_set_http_response_fields_when_storing_header_values_is_enabled()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_http_response_fields_when_storing_header_values_is_enabled()
```
...
### `it_should_set_http_response_fields_when_storing_header_values_is_disabled()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_http_response_fields_when_storing_header_values_is_disabled()
```
...
### `it_should_truncate_http_response_body_field_when_string_is_too_long()`

`ISTEST`

#### Signature
```apex
private static void it_should_truncate_http_response_body_field_when_string_is_too_long()
```
...
### `it_should_skip_setting_rest_response_fields_when_response_is_null()`

`ISTEST`

#### Signature
```apex
private static void it_should_skip_setting_rest_response_fields_when_response_is_null()
```
...
### `it_should_set_rest_request_fields_when_storing_header_values_is_enabled()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_rest_request_fields_when_storing_header_values_is_enabled()
```
...
### `it_should_set_rest_request_fields_when_storing_header_values_is_disabled()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_rest_request_fields_when_storing_header_values_is_disabled()
```
...
### `it_should_truncate_rest_request_body_field_when_string_is_too_long()`

`ISTEST`

#### Signature
```apex
private static void it_should_truncate_rest_request_body_field_when_string_is_too_long()
```
...
### `it_should_set_rest_response_fields_when_storing_header_values_is_enabled()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_rest_response_fields_when_storing_header_values_is_enabled()
```
...
### `it_should_set_rest_response_fields_when_storing_header_values_is_disabled()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_rest_response_fields_when_storing_header_values_is_disabled()
```
...
### `it_should_truncate_rest_response_body_field_when_string_is_too_long()`

`ISTEST`

#### Signature
```apex
private static void it_should_truncate_rest_response_body_field_when_string_is_too_long()
```
...
### `it_should_set_tags_string_for_list_of_tags()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_tags_string_for_list_of_tags()
```
...
### `it_should_deduplicate_and_sort_tags()`

`ISTEST`

#### Signature
```apex
private static void it_should_deduplicate_and_sort_tags()
```
...
### `it_should_not_set_stack_trace_for_new_builder_instance_when_disabled_via_logger_parameter()`

`ISTEST`

#### Signature
```apex
private static void it_should_not_set_stack_trace_for_new_builder_instance_when_disabled_via_logger_parameter()
```
...
### `it_should_not_set_stack_trace_for_parseStackTrace_method_when_disabled_via_logger_parameter()`

`ISTEST`

#### Signature
```apex
private static void it_should_not_set_stack_trace_for_parseStackTrace_method_when_disabled_via_logger_parameter()
```
...
### `it_should_use_logger_stack_trace_class_to_set_origin_fields()`

`ISTEST`

#### Signature
```apex
private static void it_should_use_logger_stack_trace_class_to_set_origin_fields()
```
...
### `it_should_use_logger_stack_trace_class_to_set_exception_fields()`

`ISTEST`

#### Signature
```apex
private static void it_should_use_logger_stack_trace_class_to_set_exception_fields()
```
...
### `it_should_return_value_of_shouldSave_when_true()`

`ISTEST`

#### Signature
```apex
private static void it_should_return_value_of_shouldSave_when_true()
```
...
### `it_should_return_value_of_shouldSave_when_false()`

`ISTEST`

#### Signature
```apex
private static void it_should_return_value_of_shouldSave_when_false()
```
...
### `it_should_set_save_reason_when_user_logging_level_met()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_save_reason_when_user_logging_level_met()
```
...
### `it_should_set_save_reason_when_entry_saving_is_overridden()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_save_reason_when_entry_saving_is_overridden()
```
...
#### Signature
```apex
private static void it_should_set_user_fields_when_anonymous_mode_disabled()
```
...
### `it_should_not_set_user_fields_when_anonymous_mode_is_enabled()`

`ISTEST`

#### Signature
```apex
private static void it_should_not_set_user_fields_when_anonymous_mode_is_enabled()
```
...
### `it_should_set_single_field_with_specified_value()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_single_field_with_specified_value()
```
...
### `it_should_set_map_of_fields_with_specified_values()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_map_of_fields_with_specified_values()
```
...
### `it_should_set_single_field_with_truncated_string_value()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_single_field_with_truncated_string_value()
```
...
### `it_gracefully_handles_invalid_value_for_field()`

`ISTEST`

#### Signature
```apex
private static void it_gracefully_handles_invalid_value_for_field()
```
...
### `it_should_use_configured_log_entry_event_fields_for_debug_string()`

`ISTEST`

#### Signature
```apex
private static void it_should_use_configured_log_entry_event_fields_for_debug_string()
```
...
### `getSocialSecurityNumberDataMaskRule()`

#### Signature
```apex
private static LogEntryDataMaskRule__mdt getSocialSecurityNumberDataMaskRule()
```

#### Return Type
**[LogEntryDataMaskRule__mdt](../objects/LogEntryDataMaskRule__mdt.md)**
...
#### Signature
```apex
private static LoggerSettings__c getUserSettings()
```

#### Return Type
**[LoggerSettings__c](../objects/LoggerSettings__c.md)**
...
|------|------|-------------|
| userSettings | [LoggerSettings__c](../objects/LoggerSettings__c.md) |  |
...
#### Fields
##### `cachedAuthSessionQueryCount`

###### Signature
```apex
private cachedAuthSessionQueryCount
```
...
##### `cachedOrganizationQueryCount`

###### Signature
```apex
private cachedOrganizationQueryCount
```
...
##### `cachedUserQueryCount`

###### Signature
```apex
private cachedUserQueryCount
```
...
##### `setCachedAuthSessionProxy(mockAuthSessionProxy)`
...
| Name | Type | Description |
|------|------|-------------|
| mockAuthSessionProxy | LoggerSObjectProxy.AuthSession |  |
