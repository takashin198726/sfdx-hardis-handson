...
```mermaid
graph TD
  LogEntryHandler_Tests["LogEntryHandler_Tests"]:::mainApexClass
  click LogEntryHandler_Tests "/objects/LogEntryHandler_Tests/"
  ...
  LogEntryHandler_Tests --> LogEntryHandler
  LogEntryHandler_Tests --> Logger
  LogEntryHandler_Tests --> LoggerConfigurationSelector
  LogEntryHandler_Tests --> LoggerDataStore
  LogEntryHandler_Tests --> LoggerMockDataCreator
  LogEntryHandler_Tests --> LoggerParameter
  LogEntryHandler_Tests --> LoggerSObjectHandler
  LogEntryHandler_Tests --> LoggerSObjectProxy
  LogEntryHandler_Tests --> LoggerStackTrace
  LogEntryHandler_Tests --> LoggerTestConfigurator
  LogEntryHandler_Tests --> LoggerTriggerableContext
  LogEntryHandler_Tests --> LogManagementDataSelector
...
private class LogEntryHandler_Tests {
  ...
  static void it_should_set_origin_omni_process_details() {
    ...
    Schema.SObjectType omniProcessSObjectType = ((SObject) (System.Type.forName('Schema.OmniProcess').newInstance())).getSObjectType();
    LoggerSObjectProxy.OmniProcess mockOmniProcessProxy = new LoggerSObjectProxy.OmniProcess();
    ...
    mockOmniProcessProxy.Id = LoggerMockDataCreator.createId(omniProcessSObjectType);
...
### `it_should_return_the_logEntry_sobjectType()`

`ISTEST`

#### Signature
```apex
private static void it_should_return_the_logEntry_sobjectType()
```
...
### `it_should_save_log_entry_without_related_record_id()`

`ISTEST`

#### Signature
```apex
private static void it_should_save_log_entry_without_related_record_id()
```
...
### `it_should_populate_related_record_fields_on_log_entry_with_related_user_record_id()`

`ISTEST`

#### Signature
```apex
private static void it_should_populate_related_record_fields_on_log_entry_with_related_user_record_id()
```
...
### `it_should_populate_related_record_fields_on_log_entry_with_related_profile_record_id()`

`ISTEST`

#### Signature
```apex
private static void it_should_populate_related_record_fields_on_log_entry_with_related_profile_record_id()
```
...
### `it_should_not_populate_related_record_fields_on_log_entry_with_related_template_standard_object_record_id()`

`ISTEST`

#### Signature
```apex
private static void it_should_not_populate_related_record_fields_on_log_entry_with_related_template_standard_object_record_id()
```
...
### `it_should_not_populate_related_record_fields_on_log_entry_when_disabled_via_logger_parameter()`

`ISTEST`

#### Signature
```apex
private static void it_should_not_populate_related_record_fields_on_log_entry_when_disabled_via_logger_parameter()
```
...
### `it_should_set_hasDatabaseResultJson_on_before_insert()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_hasDatabaseResultJson_on_before_insert()
```
...
### `it_should_set_hasDatabaseResultJson_on_before_update()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_hasDatabaseResultJson_on_before_update()
```
...
### `it_should_set_hasExceptionStackTrace_on_before_insert()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_hasExceptionStackTrace_on_before_insert()
```
...
### `it_should_set_hasExceptionStackTrace_on_before_update()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_hasExceptionStackTrace_on_before_update()
```
...
### `it_should_set_hasHttpRequestBody_on_before_insert()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_hasHttpRequestBody_on_before_insert()
```
...
### `it_should_set_hasHttpRequestBody_on_before_update()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_hasHttpRequestBody_on_before_update()
```
...
### `it_should_set_hasHttpRequestHeaderKeys_on_before_insert()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_hasHttpRequestHeaderKeys_on_before_insert()
```
...
### `it_should_set_hasHttpRequestHeaderKeys_on_before_update()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_hasHttpRequestHeaderKeys_on_before_update()
```
...
### `it_should_set_hasHttpRequestHeaders_on_before_insert()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_hasHttpRequestHeaders_on_before_insert()
```
...
### `it_should_set_hasHttpRequestHeaders_on_before_update()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_hasHttpRequestHeaders_on_before_update()
```
...
### `it_should_set_hasHttpResponseBody_on_before_insert()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_hasHttpResponseBody_on_before_insert()
```
...
### `it_should_set_hasHttpResponseBody_on_before_update()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_hasHttpResponseBody_on_before_update()
```
...
### `it_should_set_hasHttpResponseHeaderKeys_on_before_insert()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_hasHttpResponseHeaderKeys_on_before_insert()
```
...
### `it_should_set_hasHttpResponseHeaderKeys_on_before_update()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_hasHttpResponseHeaderKeys_on_before_update()
```
...
### `it_should_set_hasHttpResponseHeaders_on_before_insert()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_hasHttpResponseHeaders_on_before_insert()
```
...
### `it_should_set_hasHttpResponseHeaders_on_before_update()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_hasHttpResponseHeaders_on_before_update()
```
...
### `it_should_set_hasRestRequestBody_on_before_insert()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_hasRestRequestBody_on_before_insert()
```
...
### `it_should_set_hasRestRequestBody_on_before_update()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_hasRestRequestBody_on_before_update()
```
...
### `it_should_set_hasRestRequestHeaderKeys_on_before_insert()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_hasRestRequestHeaderKeys_on_before_insert()
```
...
### `it_should_set_hasRestRequestHeaderKeys_on_before_update()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_hasRestRequestHeaderKeys_on_before_update()
```
...
### `it_should_set_hasRestRequestHeaders_on_before_insert()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_hasRestRequestHeaders_on_before_insert()
```
...
### `it_should_set_hasRestRequestHeaders_on_before_update()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_hasRestRequestHeaders_on_before_update()
```
...
### `it_should_set_hasRestResponseBody_on_before_insert()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_hasRestResponseBody_on_before_insert()
```
...
### `it_should_set_hasRestResponseBody_on_before_update()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_hasRestResponseBody_on_before_update()
```
...
### `it_should_set_hasRestResponseHeaderKeys_on_before_insert()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_hasRestResponseHeaderKeys_on_before_insert()
```
...
### `it_should_set_hasRestResponseHeaderKeys_on_before_update()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_hasRestResponseHeaderKeys_on_before_update()
```
...
### `it_should_set_hasRestResponseHeaders_on_before_insert()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_hasRestResponseHeaders_on_before_insert()
```
...
### `it_should_set_hasRestResponseHeaders_on_before_update()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_hasRestResponseHeaders_on_before_update()
```
...
### `it_should_set_hasInlineTags_on_before_insert()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_hasInlineTags_on_before_insert()
```
...
### `it_should_set_hasInlineTags_on_before_update()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_hasInlineTags_on_before_update()
```
...
### `it_should_set_hasRecordJson_on_before_insert()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_hasRecordJson_on_before_insert()
```
...
### `it_should_set_hasRecordJson_on_before_update()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_hasRecordJson_on_before_update()
```
...
### `it_should_set_hasStackTrace_on_before_insert()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_hasStackTrace_on_before_insert()
```
...
### `it_should_set_hasStackTrace_on_before_update()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_hasStackTrace_on_before_update()
```
...
### `it_should_set_skip_setting_apex_class_details_when_origin_location_is_null()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_skip_setting_apex_class_details_when_origin_location_is_null()
```
...
### `it_should_set_exception_apex_class_details_for_top_level_class()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_exception_apex_class_details_for_top_level_class()
```
...
### `it_should_set_origin_apex_class_details_for_top_level_class()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_origin_apex_class_details_for_top_level_class()
```
...
### `it_should_set_origin_apex_class_details_for_inner_class()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_origin_apex_class_details_for_inner_class()
```
...
### `it_should_set_origin_apex_trigger_details()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_origin_apex_trigger_details()
```
...
### `it_should_set_gracefully_skip_setting_flow_details_when_origin_location_is_not_valid_flow_api_name()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_gracefully_skip_setting_flow_details_when_origin_location_is_not_valid_flow_api_name()
```
...
### `it_should_set_origin_omni_process_details()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_origin_omni_process_details()
```
...
### `it_should_set_skip_setting_origin_omni_process_details_when_origin_source_id_is_null()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_skip_setting_origin_omni_process_details_when_origin_source_id_is_null()
```
...
#### Fields
##### `mockOmniProcessProxy`

###### Signature
```apex
private mockOmniProcessProxy
```

###### Type
LoggerSObjectProxy.OmniProcess

#### Methods
##### `getOmniProcessProxies(omniProcessIds)`
...
##### `setMockOmniProcess(omniProcessProxy)`
...
| Name | Type | Description |
|------|------|-------------|
| omniProcessProxy | LoggerSObjectProxy.OmniProcess |  |
