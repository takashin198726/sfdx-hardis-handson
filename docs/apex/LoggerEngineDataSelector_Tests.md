...
graph TD
  ...
  LoggerEngineDataSelector_Tests --> LoggerCache
  LoggerEngineDataSelector_Tests --> LoggerConfigurationSelector
...
### `it_returns_cached_auth_session_proxy_when_populated_in_cache()`

`ISTEST`

#### Signature
```apex
private static void it_returns_cached_auth_session_proxy_when_populated_in_cache()
```
...
### `it_returns_queried_auth_session_proxy_when_cache_is_not_populated()`

`ISTEST`

#### Signature
```apex
private static void it_returns_queried_auth_session_proxy_when_cache_is_not_populated()
```
...
### `it_returns_mock_auth_session_proxy_when_mock_is_provided()`

`ISTEST`

#### Signature
```apex
private static void it_returns_mock_auth_session_proxy_when_mock_is_provided()
```
...
### `it_returns_null_when_querying_network_is_disabled()`

`ISTEST`

#### Signature
```apex
private static void it_returns_null_when_querying_network_is_disabled()
```
...
### `it_returns_null_when_network_id_is_null()`

`ISTEST`

#### Signature
```apex
private static void it_returns_null_when_network_id_is_null()
```
...
### `it_returns_cached_network_proxy_when_populated_in_cache()`

`ISTEST`

#### Signature
```apex
private static void it_returns_cached_network_proxy_when_populated_in_cache()
```
...
### `it_returns_mock_network_proxy_when_mock_is_provided()`

`ISTEST`

#### Signature
```apex
private static void it_returns_mock_network_proxy_when_mock_is_provided()
```
