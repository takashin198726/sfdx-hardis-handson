...
```mermaid
graph TD
  CountDistinctClause["CountDistinctClause"]:::mainApexClass
  click CountDistinctClause "/objects/CountDistinctClause/"
...
## Constructors
### `CountDistinctClause(sObjectType, fieldMap, fieldName, alias)`

Constructor for CountDistinctClause.

#### Signature
```apex
public CountDistinctClause(Schema.SObjectType sObjectType, Map<String,Schema.SObjectField> fieldMap, String fieldName, String alias)
```
