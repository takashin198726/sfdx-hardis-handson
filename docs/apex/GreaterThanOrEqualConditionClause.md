...
# GreaterThanOrEqualConditionClause Class
...
```mermaid
graph TD
  GreaterThanOrEqualConditionClause["GreaterThanOrEqualConditionClause"]:::mainApexClass
  click GreaterThanOrEqualConditionClause "/objects/GreaterThanOrEqualConditionClause/"
...
## Constructors
### `GreaterThanOrEqualConditionClause(sObjectType, fieldMap, field, value)`

Constructor for GreaterThanOrEqualConditionClause.

#### Signature
```apex
public GreaterThanOrEqualConditionClause(Schema.SObjectType sObjectType, Map<String,Schema.SObjectField> fieldMap, String field, Object value)
```
...
| field | String | The field name to apply the greater than or equal condition on. |
