...
```mermaid
graph TD
  AverageClause["AverageClause"]:::mainApexClass
  click AverageClause "/objects/AverageClause/"
...
## Constructors
### `AverageClause(sObjectType, fieldMap, fieldName, alias)`

Constructor

#### Signature
```apex
public AverageClause(Schema.SObjectType sObjectType, Map<String,Schema.SObjectField> fieldMap, String fieldName, String alias)
```
