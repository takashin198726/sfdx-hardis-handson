...
# GreaterThanOrEqualConditionClauseTest Class
...
```mermaid
graph TD
  GreaterThanOrEqualConditionClauseTest["GreaterThanOrEqualConditionClauseTest"]:::mainApexClass
  click GreaterThanOrEqualConditionClauseTest "/objects/GreaterThanOrEqualConditionClauseTest/"
...
public class GreaterThanOrEqualConditionClauseTest {
  ...
  static void testBuild_WhenValueIsString_ThenReturnsConditionWithQuotes() {
    ...
    IConditionClause clause = new GreaterThanOrEqualConditionClause(sObjectType, fieldMap, 'Name', 'Test Corp');
  ...
  static void testBuild_WhenValueIsInteger_ThenReturnsConditionWithoutQuotes() {
    ...
    Map<String, Schema.SObjectField> fieldMap = sObjectType.getDescribe().fields.getMap();
    IConditionClause clause = new GreaterThanOrEqualConditionClause(sObjectType, fieldMap, 'Amount', 5000);
  ...
  static void testBuild_WhenValueIsDate_ThenReturnsFormattedDateLiteral() {
    ...
    IConditionClause clause = new GreaterThanOrEqualConditionClause(sObjectType, fieldMap, 'CloseDate', testDate);
  ...
  static void testBuild_WhenValueIsDatetime_ThenReturnsFormattedDatetimeLiteral() {
    ...
    Schema.SObjectType sObjectType = Account.getSObjectType();
    Map<String, Schema.SObjectField> fieldMap = sObjectType.getDescribe().fields.getMap();
    IConditionClause clause = new GreaterThanOrEqualConditionClause(
      sObjectType,
      fieldMap,
      'CreatedDate',
      testDatetime
  ...
  static void testBuild_WhenValueIsNull_ThenThrowException() {
    ...
    Schema.SObjectType sObjectType = Opportunity.getSObjectType();
    Map<String, Schema.SObjectField> fieldMap = sObjectType.getDescribe().fields.getMap();
    IConditionClause clause = new GreaterThanOrEqualConditionClause(sObjectType, fieldMap, 'Amount', null);
    ...
    try {
      ...
      String expectedMessage = 'Value cannot be null for GreaterThanOrEqual condition. field: Amount';
  ...
  static void testImmutability_WhenOverrideMetaData_ThenReturnsNewInstance() {
    ...
    IConditionClause originalClause = new GreaterThanOrEqualConditionClause(
      accountSObjectType,
      accountFieldMap,
      'NumberOfEmployees',
      100
  ...
  static void testImmutability_WhenOverrideField_ThenReturnsNewInstanceWithNewField() {
    ...
    Schema.SObjectType sObjectType = Opportunity.getSObjectType();
    Map<String, Schema.SObjectField> fieldMap = sObjectType.getDescribe().fields.getMap();
    IConditionClause originalClause = new GreaterThanOrEqualConditionClause(sObjectType, fieldMap, 'Amount', 2000);
