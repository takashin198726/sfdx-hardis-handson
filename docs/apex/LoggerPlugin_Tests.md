...
```mermaid
graph TD
  LoggerPlugin_Tests["LoggerPlugin_Tests"]:::mainApexClass
  click LoggerPlugin_Tests "/objects/LoggerPlugin_Tests/"
  ...
  LoggerPlugin_Tests --> Logger
  LoggerPlugin_Tests --> LoggerBatchableContext
  LoggerPlugin_Tests --> LoggerConfigurationSelector
  LoggerPlugin_Tests --> LoggerPlugin
  LoggerPlugin_Tests --> LoggerTriggerableContext
...
#### Signature
```apex
private static final PLUGIN_LOG_STATUS
```
...
## Methods
### `it_should_returned_all_enabled_plugin_configurations()`

`ISTEST`

#### Signature
```apex
private static void it_should_returned_all_enabled_plugin_configurations()
```
...
### `it_should_returned_filtered_plugin_configurations_in_sorted_order()`

`ISTEST`

#### Signature
```apex
private static void it_should_returned_filtered_plugin_configurations_in_sorted_order()
```
...
### `it_should_return_batchable_apex_plugin_instance_for_valid_class()`

`ISTEST`

#### Signature
```apex
private static void it_should_return_batchable_apex_plugin_instance_for_valid_class()
```
...
### `it_should_return_null_batchable_apex_plugin_instance_for_class_that_does_not_implement_batchable_plugin_interface()`

`ISTEST`

#### Signature
```apex
private static void it_should_return_null_batchable_apex_plugin_instance_for_class_that_does_not_implement_batchable_plugin_interface()
```
...
### `it_should_return_null_batchable_apex_plugin_instance_for_nonexistent_class()`

`ISTEST`

#### Signature
```apex
private static void it_should_return_null_batchable_apex_plugin_instance_for_nonexistent_class()
```
...
### `it_should_return_triggerable_apex_plugin_instance_for_valid_class()`

`ISTEST`

#### Signature
```apex
private static void it_should_return_triggerable_apex_plugin_instance_for_valid_class()
```
...
### `it_should_return_null_triggerable_apex_plugin_instance_for_class_that_does_not_implement_triggerable_plugin_interface()`

`ISTEST`

#### Signature
```apex
private static void it_should_return_null_triggerable_apex_plugin_instance_for_class_that_does_not_implement_triggerable_plugin_interface()
```
...
### `it_should_return_null_triggerable_apex_plugin_instance_for_nonexistent_class()`

`ISTEST`

#### Signature
```apex
private static void it_should_return_null_triggerable_apex_plugin_instance_for_nonexistent_class()
```
...
## Classes
### ExampleBatchPurgerPlugin Class
...
### ExampleTriggerablePlugin Class
...
### NotATriggerablePlugin Class

#### Constructors
##### `NotATriggerablePlugin()`
