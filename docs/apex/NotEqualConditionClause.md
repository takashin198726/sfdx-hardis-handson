...
```mermaid
graph TD
  NotEqualConditionClause["NotEqualConditionClause"]:::mainApexClass
  click NotEqualConditionClause "/objects/NotEqualConditionClause/"
...
## Constructors
### `NotEqualConditionClause(sObjectType, fieldMap, field, value)`

Constructor for NotEqualConditionClause.

#### Signature
```apex
public NotEqualConditionClause(Schema.SObjectType sObjectType, Map<String,Schema.SObjectField> fieldMap, String field, Object value)
```
...
| field | String | The field name to apply the not equality condition on. |
