...
SOQL `SUM()` aggregate function. 
 
This class validates that the specified field is of a numeric type (Double, Integer, 
...
```mermaid
graph TD
  SumClause["SumClause"]:::mainApexClass
  click SumClause "/objects/SumClause/"
...
## Constructors
### `SumClause(sObjectType, fieldMap, fieldName, alias)`

Constructor for SumClause.

#### Signature
```apex
public SumClause(Schema.SObjectType sObjectType, Map<String,Schema.SObjectField> fieldMap, String fieldName, String alias)
```
