...
```mermaid
graph LR
  ComponentLogger_Tests["ComponentLogger_Tests"]:::mainApexClass
  click ComponentLogger_Tests "/objects/ComponentLogger_Tests/"
  ...
  ComponentLogger_Tests --> ComponentLogger
  ComponentLogger_Tests --> Entry
  ComponentLogger_Tests --> Logger
  ComponentLogger_Tests --> Logger_Tests
  ComponentLogger_Tests --> LoggerConfigurationSelector
  ComponentLogger_Tests --> LoggerDataStore
  ComponentLogger_Tests --> LoggerMockDataStore
  ComponentLogger_Tests --> LoggerStackTrace


  ComponentLogger --> Entry
  ComponentLogger --> Logger
  ComponentLogger --> LoggerDataStore
  ComponentLogger --> LoggerStackTrace
  Logger --> Entry
...
## Methods
### `it_should_return_logger_settings()`

`ISTEST`

#### Signature
```apex
private static void it_should_return_logger_settings()
```
...
### `it_should_return_aura_exception_when_it_breaks()`

`ISTEST`

#### Signature
```apex
private static void it_should_return_aura_exception_when_it_breaks()
```
...
### `it_should_save_component_log_entry_without_stack_trace()`

`ISTEST`

#### Signature
```apex
private static void it_should_save_component_log_entry_without_stack_trace()
```
...
### `it_should_save_component_log_entry_with_browser_context()`

`ISTEST`

#### Signature
```apex
private static void it_should_save_component_log_entry_with_browser_context()
```
...
### `it_should_save_component_log_entry_without_browser_context()`

`ISTEST`

#### Signature
```apex
private static void it_should_save_component_log_entry_without_browser_context()
```
...
### `it_should_save_component_log_entry_with_valid_custom_fields()`

`ISTEST`

#### Signature
```apex
private static void it_should_save_component_log_entry_with_valid_custom_fields()
```
...
### `it_should_save_component_log_entry_with_invalid_custom_fields()`

`ISTEST`

#### Signature
```apex
private static void it_should_save_component_log_entry_with_invalid_custom_fields()
```
...
### `it_should_save_component_log_entry_without_custom_fields()`

`ISTEST`

#### Signature
```apex
private static void it_should_save_component_log_entry_without_custom_fields()
```
...
### `it_should_save_component_log_entry_with_queueable_job()`

`ISTEST`

#### Signature
```apex
private static void it_should_save_component_log_entry_with_queueable_job()
```
...
### `it_should_save_component_log_entry_with_component_error()`

`ISTEST`

#### Signature
```apex
private static void it_should_save_component_log_entry_with_component_error()
```
...
### `it_should_truncate_long_origin_stack_trace_fields_when_publishing_to_the_event_bus()`

`ISTEST`

#### Signature
```apex
private static void it_should_truncate_long_origin_stack_trace_fields_when_publishing_to_the_event_bus()
```
...
### `it_should_truncate_long_exception_stack_trace_when_publishing_to_the_event_bus()`

`ISTEST`

#### Signature
```apex
private static void it_should_truncate_long_exception_stack_trace_when_publishing_to_the_event_bus()
```
...
### `it_should_truncate_long_browser_fields_when_publishing_to_the_event_bus()`

`ISTEST`

#### Signature
```apex
private static void it_should_truncate_long_browser_fields_when_publishing_to_the_event_bus()
```
...
### `it_should_set_aura_javascript_origin_stack_trace_details()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_aura_javascript_origin_stack_trace_details()
```
...
### `it_should_set_lwc_javascript_origin_stack_trace_details()`

`ISTEST`

#### Signature
```apex
private static void it_should_set_lwc_javascript_origin_stack_trace_details()
```
...
#### Return Type
**ComponentLogger.ComponentLogEntry**

---

### `createMockComponentStackTrace()`
...
#### Return Type
**ComponentLogger.ComponentStackTrace**

---

### `createMockComponentStackTrace(sourceMetadataType, componentApiName, componentFunctionName)`

#### Signature
```apex
private static ComponentLogger.ComponentStackTrace createMockComponentStackTrace(LoggerStackTrace.SourceMetadataType sourceMetadataType, String componentApiName, String componentFunctionName)
```

#### Parameters
| Name | Type | Description |
|------|------|-------------|
| sourceMetadataType | LoggerStackTrace.SourceMetadataType |  |
