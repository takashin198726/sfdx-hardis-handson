...
# LoggerCache_Tests Class

`SUPPRESSWARNINGS`
`ISTEST`

When testing Platform Cache partitions, there is no way to directly mock the partitions. Furthermore, the partitions 
...
```mermaid
graph TD
  LoggerCache_Tests["LoggerCache_Tests"]:::mainApexClass
  click LoggerCache_Tests "/objects/LoggerCache_Tests/"
  Logger["Logger"]:::apexClass
  LoggerCache["LoggerCache"]:::apexClass

  LoggerCache_Tests --> Logger
  LoggerCache_Tests --> LoggerCache
...
## Methods
### `it_adds_new_key_to_transaction_cache()`

`ISTEST`

#### Signature
```apex
private static void it_adds_new_key_to_transaction_cache()
```
...
### `it_adds_new_key_with_null_value_to_transaction_cache()`

`ISTEST`

#### Signature
```apex
private static void it_adds_new_key_with_null_value_to_transaction_cache()
```
...
### `it_updates_value_for_existing_key_in_transaction_cache()`

`ISTEST`

#### Signature
```apex
private static void it_updates_value_for_existing_key_in_transaction_cache()
```
...
### `it_removes_value_for_existing_key_in_transaction_cache()`

`ISTEST`

#### Signature
```apex
private static void it_removes_value_for_existing_key_in_transaction_cache()
```
...
### `it_adds_new_key_to_organization_and_transaction_cache_when_platform_cache_is_available()`

`ISTEST`

#### Signature
```apex
private static void it_adds_new_key_to_organization_and_transaction_cache_when_platform_cache_is_available()
```
...
### `it_adds_new_key_with_null_value_to_organization_and_transaction_cache_when_platform_cache_is_available()`

`ISTEST`

#### Signature
```apex
private static void it_adds_new_key_with_null_value_to_organization_and_transaction_cache_when_platform_cache_is_available()
```
...
### `it_adds_new_key_to_only_transaction_cache_when_organization_platform_cache_is_not_available()`

`ISTEST`

#### Signature
```apex
private static void it_adds_new_key_to_only_transaction_cache_when_organization_platform_cache_is_not_available()
```
...
### `it_updates_value_for_existing_key_in_organization_and_transaction_cache_when_platform_cache_is_available()`

`ISTEST`

#### Signature
```apex
private static void it_updates_value_for_existing_key_in_organization_and_transaction_cache_when_platform_cache_is_available()
```
...
### `it_returns_value_in_transaction_cache_when_organization_and_transaction_cache_both_contain_key()`

`ISTEST`

#### Signature
```apex
private static void it_returns_value_in_transaction_cache_when_organization_and_transaction_cache_both_contain_key()
```
...
### `it_removes_value_for_existing_key_in_organization_and_transaction_cache_when_platform_cache_is_available()`

`ISTEST`

#### Signature
```apex
private static void it_removes_value_for_existing_key_in_organization_and_transaction_cache_when_platform_cache_is_available()
```
...
### `it_adds_new_key_to_session_and_transaction_cache_when_platform_cache_is_available()`

`ISTEST`

#### Signature
```apex
private static void it_adds_new_key_to_session_and_transaction_cache_when_platform_cache_is_available()
```
...
### `it_adds_new_key_with_null_value_to_session_and_transaction_cache_when_platform_cache_is_available()`

`ISTEST`

#### Signature
```apex
private static void it_adds_new_key_with_null_value_to_session_and_transaction_cache_when_platform_cache_is_available()
```
...
### `it_adds_new_key_to_only_transaction_cache_when_session_platform_cache_is_not_available()`

`ISTEST`

#### Signature
```apex
private static void it_adds_new_key_to_only_transaction_cache_when_session_platform_cache_is_not_available()
```
...
### `it_updates_value_for_existing_key_in_session_and_transaction_cache_when_platform_cache_is_available()`

`ISTEST`

#### Signature
```apex
private static void it_updates_value_for_existing_key_in_session_and_transaction_cache_when_platform_cache_is_available()
```
...
### `it_returns_value_in_transaction_cache_when_session_and_transaction_cache_both_contain_key()`

`ISTEST`

#### Signature
```apex
private static void it_returns_value_in_transaction_cache_when_session_and_transaction_cache_both_contain_key()
```
...
### `it_removes_value_for_existing_key_in_session_and_transaction_cache_when_platform_cache_is_available()`

`ISTEST`

#### Signature
```apex
private static void it_removes_value_for_existing_key_in_session_and_transaction_cache_when_platform_cache_is_available()
```
...
## Classes
### MockPlatformCachePartitionDelegate Class
...
##### `isAvailableMethodCallCount`

###### Signature
```apex
public isAvailableMethodCallCount
```
...
##### `containsMethodCallCount`

###### Signature
```apex
public containsMethodCallCount
```
...
#### Constructors
##### `MockPlatformCachePartitionDelegate(isAvailable)`
...
##### `put(key, value, cacheTtlSeconds, cacheVisiblity, isCacheImmutable)`
...
| cacheVisiblity | Cache.Visibility |  |
| isCacheImmutable | Boolean |  |
