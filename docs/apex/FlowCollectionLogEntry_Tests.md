...
# FlowCollectionLogEntry_Tests Class
...
```mermaid
graph TD
  FlowCollectionLogEntry_Tests["FlowCollectionLogEntry_Tests"]:::mainApexClass
  click FlowCollectionLogEntry_Tests "/objects/FlowCollectionLogEntry_Tests/"
  ...
  FlowCollectionLogEntry_Tests --> FlowCollectionLogEntry
  FlowCollectionLogEntry_Tests --> Logger
  FlowCollectionLogEntry_Tests --> LoggerConfigurationSelector
  FlowCollectionLogEntry_Tests --> LoggerDataStore
  FlowCollectionLogEntry_Tests --> LoggerMockDataStore
  FlowCollectionLogEntry_Tests --> LoggerTestConfigurator


  FlowCollectionLogEntry --> Entry
  FlowCollectionLogEntry --> Logger
  Logger --> Entry
...
## Methods
### `createFlowCollectionLogEntry()`

#### Signature
```apex
private static FlowCollectionLogEntry createFlowCollectionLogEntry()
```
