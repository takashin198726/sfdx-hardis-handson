...
# InSubQueryConditionClauseTest Class
...
```mermaid
graph TD
  InSubQueryConditionClauseTest["InSubQueryConditionClauseTest"]:::mainApexClass
  click InSubQueryConditionClauseTest "/objects/InSubQueryConditionClauseTest/"
...
linkStyle 3 stroke:#FF8C00,stroke-width:2px;
linkStyle 4,5,6,7,8,9,10,11 stroke:#A6A6A6,stroke-width:2px;
```
...
## Methods
### `testBuild_WhenSubQueryIsValid_ThenReturnsInSubQueryClause()`

`ISTEST`

#### Signature
```apex
private static void testBuild_WhenSubQueryIsValid_ThenReturnsInSubQueryClause()
```
