...
# IncludesConditionClauseTest Class
...
```mermaid
graph TD
  IncludesConditionClauseTest["IncludesConditionClauseTest"]:::mainApexClass
  click IncludesConditionClauseTest "/objects/IncludesConditionClauseTest/"
...
## Methods
### `testBuild_WhenValueIsStringList_ThenReturnsIncludesClause()`

`ISTEST`

#### Signature
```apex
private static void testBuild_WhenValueIsStringList_ThenReturnsIncludesClause()
```
...
### `testBuild_WhenValueIsEmptyList_ThenReturnsEmptyIncludesClause()`

`ISTEST`

#### Signature
```apex
private static void testBuild_WhenValueIsEmptyList_ThenReturnsEmptyIncludesClause()
```
