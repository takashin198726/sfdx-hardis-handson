...
# GreaterThanConditionClauseTest Class
...
```mermaid
graph TD
  GreaterThanConditionClauseTest["GreaterThanConditionClauseTest"]:::mainApexClass
  click GreaterThanConditionClauseTest "/objects/GreaterThanConditionClauseTest/"
  ...
  GreaterThanConditionClauseTest --> GreaterThanConditionClause
...
public class GreaterThanConditionClauseTest {
  ...
  static void testBuild_WhenValueIsString_ThenReturnsConditionWithQuotes() {
    ...
    IConditionClause clause = new GreaterThanConditionClause(sObjectType, fieldMap, 'Name', 'Test Corp');
  ...
  static void testBuild_WhenValueIsInteger_ThenReturnsConditionWithoutQuotes() {
    ...
    Map<String, Schema.SObjectField> fieldMap = sObjectType.getDescribe().fields.getMap();
    IConditionClause clause = new GreaterThanConditionClause(sObjectType, fieldMap, 'Amount', 5000);
  ...
  static void testBuild_WhenValueIsDate_ThenReturnsFormattedDateLiteral() {
    ...
    IConditionClause clause = new GreaterThanConditionClause(sObjectType, fieldMap, 'CloseDate', testDate);
  ...
  static void testBuild_WhenValueIsDatetime_ThenReturnsFormattedDatetimeLiteral() {
    ...
    Schema.SObjectType sObjectType = Account.getSObjectType();
    Map<String, Schema.SObjectField> fieldMap = sObjectType.getDescribe().fields.getMap();
    IConditionClause clause = new GreaterThanConditionClause(sObjectType, fieldMap, 'CreatedDate', testDatetime);
  ...
  static void testBuild_WhenValueIsNull_ThenThrowException() {
    ...
    Schema.SObjectType sObjectType = Opportunity.getSObjectType();
    Map<String, Schema.SObjectField> fieldMap = sObjectType.getDescribe().fields.getMap();
    IConditionClause clause = new GreaterThanConditionClause(sObjectType, fieldMap, 'Amount', null);
    ...
    try {
      ...
      String expectedMessage = 'Value cannot be null for GreaterThan condition. field: Amount';
  ...
  static void testImmutability_WhenOverrideMetaData_ThenReturnsNewInstance() {
    ...
    IConditionClause originalClause = new GreaterThanConditionClause(
      accountSObjectType,
      accountFieldMap,
      'NumberOfEmployees',
      100
  ...
  static void testImmutability_WhenOverrideField_ThenReturnsNewInstanceWithNewField() {
    ...
    Schema.SObjectType sObjectType = Opportunity.getSObjectType();
    Map<String, Schema.SObjectField> fieldMap = sObjectType.getDescribe().fields.getMap();
    IConditionClause originalClause = new GreaterThanConditionClause(sObjectType, fieldMap, 'Amount', 2000);
