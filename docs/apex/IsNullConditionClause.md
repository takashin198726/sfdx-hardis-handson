...
```mermaid
graph TD
  IsNullConditionClause["IsNullConditionClause"]:::mainApexClass
  click IsNullConditionClause "/objects/IsNullConditionClause/"
...
## Constructors
### `IsNullConditionClause(sObjectType, fieldMap, field)`

Constructor for IsNullConditionClause.

#### Signature
```apex
public IsNullConditionClause(Schema.SObjectType sObjectType, Map<String,Schema.SObjectField> fieldMap, String field)
```
...
| field | String | The field name to apply the equality to null condition on. |
