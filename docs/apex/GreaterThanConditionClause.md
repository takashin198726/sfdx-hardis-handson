...
```mermaid
graph TD
  GreaterThanConditionClause["GreaterThanConditionClause"]:::mainApexClass
  click GreaterThanConditionClause "/objects/GreaterThanConditionClause/"
...
public with sharing class GreaterThanConditionClause extends AbstractConditionClause {
  ...
  /**
   * Constructor for GreaterThanConditionClause.
   *
   * @param sObjectType The Schema.SObjectType of the object.
   * @param fieldMap A map of field names to Schema.SObjectField.
   * @param field The field name to apply the greater than condition on.
   * @param value The value to compare against.
   */
  public GreaterThanConditionClause(
  ...
  public override IConditionClause overrideMetaData(
    ...
    return new GreaterThanConditionClause(sObjectType, fieldMap, this.field, this.value);
  }
  ...
  public override IConditionClause overrideField(String field) {
    return new GreaterThanConditionClause(this.sObjectType, this.fieldMap, field, this.value);
  }
  ...
  private String checkAndCast() {
    if (value == null) {
      throw new QueryException('Value cannot be null for GreaterThan condition. field: ' + field);
    }
...
## Constructors
### `GreaterThanConditionClause(sObjectType, fieldMap, field, value)`

Constructor for GreaterThanConditionClause.

#### Signature
```apex
public GreaterThanConditionClause(Schema.SObjectType sObjectType, Map<String,Schema.SObjectField> fieldMap, String field, Object value)
```
...
| field | String | The field name to apply the greater than condition on. |
