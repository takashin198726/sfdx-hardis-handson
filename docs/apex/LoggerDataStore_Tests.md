...
```mermaid
graph TD
  LoggerDataStore_Tests["LoggerDataStore_Tests"]:::mainApexClass
  click LoggerDataStore_Tests "/objects/LoggerDataStore_Tests/"
  ...
  LoggerDataStore_Tests --> Logger
  LoggerDataStore_Tests --> LoggerConfigurationSelector
  LoggerDataStore_Tests --> LoggerDataStore
  LoggerDataStore_Tests --> LoggerMockDataCreator
...
linkStyle 5,6,7,8,9,10 stroke:#A6A6A6,stroke-width:2px;
```
...
private class LoggerDataStore_Tests {
  ...
  private class MockQueueable implements System.Queueable {
    public Integer callCount = 0;
...
## Methods
### `it_should_delete_record()`

`ISTEST`

#### Signature
```apex
private static void it_should_delete_record()
```
...
### `it_should_delete_record_list()`

`ISTEST`

#### Signature
```apex
private static void it_should_delete_record_list()
```
...
### `it_should_partially_delete_record_list_when_allOrNone_is_false()`

`ISTEST`

#### Signature
```apex
private static void it_should_partially_delete_record_list_when_allOrNone_is_false()
```
...
### `it_should_hard_delete_record()`

`ISTEST`

#### Signature
```apex
private static void it_should_hard_delete_record()
```
...
### `it_should_hard_delete_record_list()`

`ISTEST`

#### Signature
```apex
private static void it_should_hard_delete_record_list()
```
...
### `it_should_insert_record()`

`ISTEST`

#### Signature
```apex
private static void it_should_insert_record()
```
...
### `it_should_insert_record_list()`

`ISTEST`

#### Signature
```apex
private static void it_should_insert_record_list()
```
...
### `it_should_partially_insert_record_list_when_allOrNone_is_false()`

`ISTEST`

#### Signature
```apex
private static void it_should_partially_insert_record_list_when_allOrNone_is_false()
```
...
### `it_should_partially_insert_record_list_when_allOrNone_is_false_in_dml_options()`

`ISTEST`

#### Signature
```apex
private static void it_should_partially_insert_record_list_when_allOrNone_is_false_in_dml_options()
```
...
### `it_should_undelete_record()`

`ISTEST`

#### Signature
```apex
private static void it_should_undelete_record()
```
...
### `it_should_undelete_records()`

`ISTEST`

#### Signature
```apex
private static void it_should_undelete_records()
```
...
### `it_should_partially_undelete_records_when_allOrNone_is_false()`

`ISTEST`

#### Signature
```apex
private static void it_should_partially_undelete_records_when_allOrNone_is_false()
```
...
### `it_should_update_record()`

`ISTEST`

#### Signature
```apex
private static void it_should_update_record()
```
...
### `it_should_update_record_list()`

`ISTEST`

#### Signature
```apex
private static void it_should_update_record_list()
```
...
### `it_should_partially_update_record_list_when_allOrNone_is_false()`

`ISTEST`

#### Signature
```apex
private static void it_should_partially_update_record_list_when_allOrNone_is_false()
```
...
### `it_should_partially_update_record_list_when_allOrNone_is_false_in_dml_options()`

`ISTEST`

#### Signature
```apex
private static void it_should_partially_update_record_list_when_allOrNone_is_false_in_dml_options()
```
...
### `it_should_upsert_record()`

`ISTEST`

#### Signature
```apex
private static void it_should_upsert_record()
```
...
### `it_should_upsert_record_list()`

`ISTEST`

#### Signature
```apex
private static void it_should_upsert_record_list()
```
...
### `it_should_partially_upsert_record_list_when_allOrNone_is_false()`

`ISTEST`

#### Signature
```apex
private static void it_should_partially_upsert_record_list_when_allOrNone_is_false()
```
...
### `it_should_publish_platform_event_record()`

`ISTEST`

#### Signature
```apex
private static void it_should_publish_platform_event_record()
```
...
### `it_should_publish_platform_event_record_list()`

`ISTEST`

#### Signature
```apex
private static void it_should_publish_platform_event_record_list()
```
...
### `it_should_enqueue_job()`

`ISTEST`

#### Signature
```apex
private static void it_should_enqueue_job()
```
...
### `it_should_support_overriding_database_instance()`

`ISTEST`

#### Signature
```apex
private static void it_should_support_overriding_database_instance()
```
...
### `it_should_support_overriding_event_bus_instance()`

`ISTEST`

#### Signature
```apex
private static void it_should_support_overriding_event_bus_instance()
```
...
### `it_should_support_overriding_job_queue_instance()`

`ISTEST`

#### Signature
```apex
private static void it_should_support_overriding_job_queue_instance()
```
